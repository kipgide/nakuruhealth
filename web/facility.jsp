...
insertPersons=con.prepareStatement("INSERT INTO facityregister (name,subcounty,facilityhead,nofstaff,address,contacts)"
        + "VALUES(?,?,?,?,?,?)");
...
public int setPerson(String name,String subcounty,String facilityhead,String nofstaff,String address,String contacts){
int result=0;
try{
 insertPersons.setString(1, name);
 insertPersons.setString(2, subcounty);
 insertPersons.setString(3, facilityhead);
...
int result=0;
 ...
 String facilityhead=new String();
 ...
 if (request.getParameter("facilityhead")!=null){
 facilityhead=request.getParameter("facilityhead");
 }
 ...
 result = person.setPerson(name, subcounty, facilityhead, nofstaff, address, contacts);
        ...
        <form name="insert" action="facility.jsp" method="POST">
            ...
            <table border="1">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="facilityhead" value="" /></td>
                    </tr>
                    <tr>
